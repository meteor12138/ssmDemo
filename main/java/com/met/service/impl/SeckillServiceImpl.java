...
import com.met.dao.SeckillDao;
import com.met.dao.SuccessKilledDao;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    // md5盐值字符串，用于混淆MD5
    public final String slat = "nsdjiqh^*&$%#hbdjbsajhjasbkU(&*^*%$%UGbdbsja";
    ...
    public Exposer exportsSeckillUrl(long seckillId) {
    ...
    public SeckillExecution executeSeckill(long seckillId, long userPhone, String md5) throws SeckillException, RepeatKillException, SeckillCloseException {
        ...
        try {
            ...
            if (updateCount <= 0) {
                ...
                // 记录购买行为
                int insertCount = successKilledDao.insertSuccessKilled(seckillId, userPhone, SeckillStateEnum.SUCCESS.getState());
                if (insertCount <= 0) {
                    // 重复秒杀
